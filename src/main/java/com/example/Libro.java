...
public class Libro {
    ...
    public Libro(String titulo, String autor, double precio) {
        this.titulo = titulo;
        this.autor = autor;
        setPrecio(precio); // Usar setter para validar el precio
    }
    
    // TODO: Crear constructor con solo titulo y autor (precio = 0.0)
    public Libro(String titulo, String autor) {
        this(titulo, autor, 0.0); // Llama al constructor completo con precio 0.0
    }
    ...
    public void aplicarDescuento(double porcentaje) {
        ...
        setPrecio(nuevoPrecio); // Usar setter para validar el nuevo precio
    }
    ...
    public void aplicarDescuento(double porcentaje, double montoMaximo) {
        ...
        if (descuento > montoMaximo) {
            descuento = montoMaximo; // Limitar el descuento al monto máximo
        }
        double nuevoPrecio = precio - descuento;
        setPrecio(nuevoPrecio); // Usar setter para validar el nuevo precio
    }
